...
class VitaminRequest extends StatefulWidget {
  VitaminRequest({
    Key? key,
  }) : super(key: key);

  @override
  State<VitaminRequest> createState() => _VitaminRequestState();
}

class _VitaminRequestState extends State<VitaminRequest> {
                          ...
                          child: ListTile(
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                ...
                                Text(
                                    "Service Type: Vitamin IV Drips And Fluids".tr)
                              ],
                            ),
