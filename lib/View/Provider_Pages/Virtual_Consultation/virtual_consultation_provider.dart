...
class VirtualConsultationRequest extends StatefulWidget {
  VirtualConsultationRequest({
    Key? key,
  }) : super(key: key);

  @override
  State<VirtualConsultationRequest> createState() =>
      _VirtualConsultationRequestState();
}

class _VirtualConsultationRequestState
    extends State<VirtualConsultationRequest> {
                          ...
                          child: ListTile(
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                ...
                                Text("Service Type: Virtual Consultation")
                              ],
                            ),
